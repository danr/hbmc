...
-- pathfind_small ds = question (goal smallMap (walkKeychain smallMap False ds (Z,Z)))

-- pathfind_med   ds = question (goal mediumMap (walkKeychain mediumMap False ds (Z,Z)))

pathfind_big   ds = question (goal bigMap (walk bigMap ds (Z,Z)))
